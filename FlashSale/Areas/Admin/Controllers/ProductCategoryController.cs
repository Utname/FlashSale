...
namespace FlashSale.Areas.Admin.Controllers
{
    public class ProductCategoryController : Controller
    {
        ...
        mapProductCategory map = new mapProductCategory();

        [AuthorizationCheck(ChucNang = "ProductCategory_Index")]
        ...
        [AuthorizationCheck(ChucNang = "ProductCategory_Insert")]
        ...
        [HttpPost]
        public ActionResult Insert(ProductCategoryModel model)
        {
        ...
        int CheckValidation(ProductCategoryModel model)
        {
        ...
        [AuthorizationCheck(ChucNang = "ProductCategory_Edit")]
        ...
        [HttpGet]
        [AuthorizationCheck(ChucNang = "ProductCategory_UpdateStatusDel")]
        ...
        [AuthorizationCheck(ChucNang = "ProductCategory_Details")]
